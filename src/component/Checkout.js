                        ...
                        <form className="needs-validation" novalidate="">
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    <label  htmlhtmlFor="firstName" className="form-label">First name</label>
                                ...
                                <div className="col-12">
                                    <label  htmlhtmlFor="email" className="form-label">Email <span className="text-muted">(Optional)</span></label>
                                ...
                                <div className="col-12">
                                    <label  htmlhtmlFor="address2" className="form-label">Address 2 <span className="text-muted">(Optional)</span></label>
