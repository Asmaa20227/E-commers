        ...
        return (
            <>
                ...
                <div className='col-md-6'>
                    ...
                    <h3 display-6 fw-bold my-4>${product.price}</h3>
                    <p className="lead"> {product.description}</p> 
                    < button  className="btn btn-outline-dark" onClick={()=>addproduct(product)}>Add to Cart</button>
                    < NavLink  as={Link} to="/cart" className="btn btn-outline-dark ms-2 px-3 py-2">Go to Cart</ NavLink >
                </div>
